...
import { BookOpen, User, CheckCircle, Award, LogOut, Heart } from 'lucide-react';
...
const StudentLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const links = [
    { to: '/student/dashboard', label: 'Dashboard', icon: <User /> },
    { to: '/tutorials', label: 'Tutorials', icon: <BookOpen /> },
    { to: '/quizzes', label: 'Quizzes', icon: <CheckCircle /> },
